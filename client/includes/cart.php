    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <tr>
                                            ...
                                            <td class="product-thumbnail">
                                                ...
                                                if (!empty($imageNames[0])): ?>
                                                    <a href="?act=detail&id=<?= $cart[0] ?>"><img src="images/<?= $imageNames[0] ?>"
                                                            alt="product img" width="60px" height="86px" /></a>
                                                <?php endif; ?>
                                            </td>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="buttons-cart--inner">
                                    ...
                                    <div class="buttons-cart checkout--btn">
                                        ...
                                        ?>
                                        <a href="?act=viewcart&del=1"
                                            onclick="return confirm('Bạn có chắc chắn muốn xóa tất cả sản phẩm khỏi giỏ hàng không?')">Xóa
                                            tất cả</a>
                ...
                <?php else: ?>
                    <div class="no-product-message d-flex flex-column align-items-center justify-content-center">
                        <h2>Không có sản phẩm nào trong giỏ hàng của bạn.</h2>
                        <a class="btn btn-danger rounded-0 mt-3" href="?act=shop">Tiếp tục mua sắm</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
