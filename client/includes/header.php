                ...
                <div class="row">
                    <div class="menumenu__container clearfix">
                        <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5">
                            <div class="logo">
                                <a href="?act=home"><img src="images/logo-rb.png" alt="logo images"
                                        style="width: 105px;"></a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-lg-2 col-sm-4 col-xs-4">
                            <div class="header__right">
                                ...
                                if (!isset($_SESSION['login']['username'])): ?>
                                    <div class="dropdown">
                                        <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"
                                            style="margin: 0px 10px;">Tài khoản</button>
                                ...
                                <?php else: ?>
                                    <div class="dropdown">
                                        <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"
                                            style="margin: 0px 10px;">Xin Chào, <?= $_SESSION['login']['username'] ?? "" ?>
                                        </button>
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="?act=updateUser&id=<?= $_SESSION['login']['id'] ?? "" ?>"
                                                    height="auto">Cập nhật thông tin</a>
                                            </li>
                                            <li>
                                                <a href="?act=forgot" height="auto">Quên mật khẩu</a>
                                            </li>
                                ...
                                <?php endif; ?>
                                <?php if (strpos($_SERVER['REQUEST_URI'], '?act=cart') === false && strpos($_SERVER['REQUEST_URI'], '?act=viewcart') === false): ?>
                    ...
                    <div class="shp__cart__wrap">
                                    ...
                                    <div class="shp__pro__thumb">
                                        <a href="#">
                                            ...
                                            if (!empty($imageNames[0])) {
                                                ?>
                                                <a href="#"><img src="images/<?= $imageNames[0] ?>" alt="product img" height="70px"
                                                        width="99px" /></a>
                                            <?php } ?>
                                        </a>
                                    </div>
                        ...
                        <?php } else { ?>
                            ...
                            <div class="shp__single__product">
                                <ul class="shopping__btn">
                                    <strong>
                                        <h4 class="mb-3">Không có sản phẩm nào trong giỏ hàng của bạn.</h4>
                                    </strong>
                                    <li><a href="?act=shop">Quay lại mua hàng</a></li>
                                </ul>
                            </div>
                        <?php } ?>
                    </div>
